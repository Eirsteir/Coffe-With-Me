...
// @ComponentScan(basePackages = { "com.eirsteir.coffeewithme.social" }, excludeFilters = {
// @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = { SetupTestDataLoader.class })
// })
