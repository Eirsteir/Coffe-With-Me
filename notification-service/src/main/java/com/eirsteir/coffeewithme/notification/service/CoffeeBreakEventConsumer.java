...
public class CoffeeBreakEventConsumer extends EventConsumer {
    ...
    public DomainEventHandlers domainEventHandlers() {
        return DomainEventHandlersBuilder
                .forAggregateType("com.eirsteir.coffeewithme.social.domain.coffeebreak.CoffeeBreak")
                .onEvent(CoffeeBreakCreatedEvent.class, this::handleCoffeeBreakCreatedEvent)
                .build();
    }

    private void handleCoffeeBreakCreatedEvent(DomainEventEnvelope<CoffeeBreakCreatedEvent> domainEventEnvelope) {
